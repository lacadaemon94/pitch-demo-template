...
exports.squircleObserver = exports.renderSquircle = void 0;
const figma_squircle_1 = require("figma-squircle");
...
const renderSquircle = (el, opts, className) => {
    ...
    if (!opts.borderWidth) {
        el.style.clipPath = `path('${(0, figma_squircle_1.getSvgPath)(augmentedOpts)}')`;
    }
    else {
        ...
        .${className} {
          position: relative;
          clip-path: path('${(0, figma_squircle_1.getSvgPath)(augmentedOpts)}');
        }
        ...
        .${className}::before {
          ...
          z-index: -1;
          clip-path: path('${(0, figma_squircle_1.getSvgPath)({
            ...augmentedOpts,
...
exports.renderSquircle = renderSquircle;
const squircleObserver = (el, opts) => {
    ...
    const func = (newOpts) => {
        ...
        return (0, exports.renderSquircle)(el, opts, className);
    };
...
exports.squircleObserver = squircleObserver;
